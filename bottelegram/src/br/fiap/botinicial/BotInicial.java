...
public class BotInicial {
	...
	/**
	 * 
	 * pergunta.toLowerCase(), o tratamento das perguntas do Telegram são sempre em maiuscula.
	 * 
	 */
 ...
 */
	 ...
	 * No método buscarPergunta que vem até este método pegar informações foi usado o comando
	 * .toLowerCase(), que ao trasformar o texto em maiusculo não vai diferenciar se foi digitado
